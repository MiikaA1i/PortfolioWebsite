    ...
    <section id="projects" className="py-24 px-4 relative">
      ...
      <div className="container mx-auto max-w-5xl">
        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-center">
          <br />
          {" "} 
          Client's <span className="text-primary"> MVP </span>
        </h2>

        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
          Here are some Minimum Viable Product's that were built for real clients.
        </p>
        </div> 
        <section id = "clientProjects" >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {clientProjects.map((project, key) => (
            <div
              key={key}
              className="group bg-card rounded-lg overflow-hidden shadow-xs card-hover"
            >
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-semibold mb-1"> {clientProjects.title}</h3>
                <p className="text-muted-foreground text-sm mb-4">
                  {project.description}
                </p>
                <div className="flex justify-between items-center">
        ...
        <div className="text-center mt-12">
          <a
            ...
            target="_blank"
            href="https://github.com/MiikaA1i"
          >
